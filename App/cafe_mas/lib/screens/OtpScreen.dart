...
import 'package:cafe_mas/screens/OtpInput.dart';
...
class _OTPScreenState extends State<OTPScreen> {
  ...
  Future<void> verifyPhone(phoneNo) async {
    ...
    final PhoneVerificationCompleted verified = (AuthCredential authResults) {
      _firebaseAuth.signInWithCredential(authResults).then((value) {
        if (value.user != null) {
    ...
    final PhoneVerificationFailed verifiedFailed =
        (FirebaseAuthException authResults) {
      showToast(authResults.message, Colors.red);
      print('${authResults.message}');
      setState(() {
        isCodeSent = false;
      });
    };
